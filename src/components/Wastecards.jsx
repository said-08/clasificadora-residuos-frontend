  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-505 text-white">
      ...
      <div className="grid grid-cols-3 gap-4">
        {list.map((item, index) => (
          // Agregar condición para evitar agregar la imagen si el label contiene "imagen irreconocible"
          !item.label.includes("imagen irreconocible") && (
            <div
              key={index}
            ...
            >
              <div className="relative overflow-hidden bg-cover bg-no-repeat">
                {/* Agregar la imagen solo si el label no contiene "imagen irreconocible" */}
                {!item.label.includes("imagen irreconocible") && (
